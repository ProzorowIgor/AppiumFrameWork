...
public class HybridAndroidApp extends TestBaseForEcommerce {
    ...
    public void appAndWebCollaboration() throws IOException, InterruptedException {
        ...
        Thread.sleep(7000);
        Set<String> contexts = driver.getContextHandles(); //capture all statements
        for (String contextName : contexts) {
            System.out.println(contextName);
        }
        driver.context("WEBVIEW_com.androidsample.generalstore");// moving from native to web statement
